  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-foreground/80 uppercase tracking-wide">Parts / Materials</h3>
      ...
      {fields.length === 0 ? (
        <p className="text-sm text-muted-foreground py-2">No parts added yet.</p>
      ) : (
