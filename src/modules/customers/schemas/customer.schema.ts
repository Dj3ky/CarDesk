...
function customerSchemaWith(t: TFn) {
  return z.object({
...
export const customerSchema = customerSchemaWith(englishT);

export function createCustomerSchema(t: TFn) {
  return customerSchemaWith(t);
}
